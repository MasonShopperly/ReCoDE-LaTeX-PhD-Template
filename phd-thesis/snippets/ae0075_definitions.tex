...
\noindent This proposal uses a measurement-first contract: every numeric claim is backed by a tracked artifact in scripts and raw logs are tracked for reproducibility (available on request).
