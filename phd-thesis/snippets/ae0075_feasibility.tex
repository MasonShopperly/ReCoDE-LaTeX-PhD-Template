...
\noindent This section summarizes the current evidence pack (\code{myNektarpp/docs/ae0075/}) and the \emph{actionable implications} for the research plan.
...
\vspace{0.4em}
\noindent\textbf{What we can now justify.}
These measurements justify a research plan centered on: (i) calibrated cost models, (ii) heterogeneity-aware weighting, and (iii) a trigger rule with bounded migration that explicitly trades benefit against overhead.
