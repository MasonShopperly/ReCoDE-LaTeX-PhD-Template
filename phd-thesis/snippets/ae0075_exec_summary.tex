...
This proposal directly targets the AE0075 studentship theme: novel algorithms for load rebalancing in adaptive simulations on heterogeneous CPU/GPU clusters, implemented and evaluated in Nektar++.
