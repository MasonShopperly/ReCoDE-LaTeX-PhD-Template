...
This proposal explicitly models both benefit and cost, then uses those models to decide \emph{when} to rebalance and \emph{how much} to migrate (bounded movement), with the entire story grounded by a tracked evidence pack (scripts and raw logs are tracked for reproducibility (available on request)).
