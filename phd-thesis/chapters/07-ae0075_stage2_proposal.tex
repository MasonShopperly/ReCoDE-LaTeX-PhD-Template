...
supplementary scripts and raw logs are available for reproducibility. All numbers below come from rerunnable scripts and archived logs (available on request).
