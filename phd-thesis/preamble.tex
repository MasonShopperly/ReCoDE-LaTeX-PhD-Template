...
\addbibresource{bibliography_ae0075.bib}
...
% AE0075: make \code robust for underscores in filenames
\providecommand{\code}[1]{\texttt{#1}}
\renewcommand{\code}[1]{\texttt{\detokenize{#1}}}

% AE0075: tabularx support (needed for \begin{tabularx})
\usepackage{array}
\usepackage{tabularx}

% AE0075: guardrails for paths/URLs (prevents drift)
